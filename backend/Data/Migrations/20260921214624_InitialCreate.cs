...
namespace backend.Data.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "UserPlanningContexts",
                columns: table => new
                {
                    UserId = table.Column<string>(type: "character varying(200)", nullable: false),
                    TimeZone = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    PreferredWorkingHours = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserPlanningContexts", x => x.UserId);
                    table.ForeignKey(
                        name: "FK_UserPlanningContexts_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PlanItems_Commitments_CommitmentId",
                        column: x => x.CommitmentId,
                        principalTable: "Commitments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_PlanItems_DailyPlans_DailyPlanId",
                        column: x => x.DailyPlanId,
                        principalTable: "DailyPlans",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PlanItems_Tasks_TaskId",
                        column: x => x.TaskId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Commitments_UserId_StartTime",
                table: "Commitments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PlanItems_CommitmentId",
                table: "PlanItems",
                column: "CommitmentId");

            migrationBuilder.CreateIndex(
                name: "IX_PlanItems_DailyPlanId_StartTime",
                table: "PlanItems",
                columns: new[] { "DailyPlanId", "StartTime" });

            migrationBuilder.CreateIndex(
                name: "IX_PlanItems_TaskId",
                table: "PlanItems",
                column: "TaskId");
